...
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING,
        uses = {UserMapper.class, MessageMapperUtil.class})
public interface MessageMapper {
    ...
    @Mapping(target = "userFrom", source = "dto", qualifiedBy = MessageMapperUtil.UserByUserFromId.class)
    @Mapping(target = "dialog", source = "dto", qualifiedBy = MessageMapperUtil.DialogByDialogId.class)
